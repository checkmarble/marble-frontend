        ...
        {bookKeys.map((bookKey) => {
          ...
          return (
            <Select.Item key={bookKey} value={bookKey} className="group">
              <Select.ItemText>
                <p className="text-s text-grey-100 group-radix-highlighted:text-blue-100 group-radix-state-open:text-blue-100 text-start font-semibold">
                  {book.title}
                </p>
                <p className="text-grey-50 group-radix-highlighted:text-blue-50 group-radix-state-open:text-blue-50 text-start text-xs font-normal">
                  {book.author}
                </p>
              </Select.ItemText>
            </Select.Item>
