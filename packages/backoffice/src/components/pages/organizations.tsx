...
import { ButtonV2, usePanel } from 'ui-design-system';
...
export const OrganizationsPage = () => {
  ...
  const handleCreateOrganization = () => {
    openPanel(<CreateOrganizationPanel />);
  };
  ...
  return (
    <div className="flex flex-col gap-v2-md">
      <div className="flex items-center justify-between">
        ...
        <ButtonV2 variant="primary" onClick={handleCreateOrganization}>
          <Icon icon="plus" className="size-4" />
          Create organization
        </ButtonV2>
      </div>
      <div className="grid grid-cols-[0px_1fr_calc(var(--spacing)*100)_auto] border border-grey-border rounded-v2-md">
