...
import { Button, Checkbox, PanelSharpFactory } from 'ui-design-system';
  ...
  return (
    <div className="flex flex-col gap-v2-sm">
      <div className="flex items-center justify-between">
        ...
        <label className="flex gap-v2-xs items-center">
          Activate auto seeding <Checkbox size="small" />
        </label>
      </div>
      <div className="border border-blue-58 rounded-v2-md p-v2-md flex flex-col gap-v2-sm">
        <span>Activating the seeding will create:</span>
        <div className="pl-v2-lg">
