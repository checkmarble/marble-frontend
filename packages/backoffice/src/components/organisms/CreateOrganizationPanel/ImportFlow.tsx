...
export const ImportFlow = ({ data }: { data: OrganizationImportData }) => {
  return (
...
const DataModelRecap = ({ data }: { data: OrganizationImportData }) => {
...
type TableLinksProps = {
  ...
  currentTable: OrganizationImportData['data_model']['tables'][number];
};
