...
export type RouteID =
  ...
  | 'routes/_builder+/inboxes+/$inboxId_/cases+/$caseId._index'
  | 'routes/_builder+/inboxes+/$inboxId_/cases+/$caseId._layout'
  | 'routes/_builder+/inboxes+/$inboxId_/cases+/$caseId.decisions'
  | 'routes/_builder+/inboxes+/$inboxId_/cases+/$caseId.files'
  | 'routes/_builder+/inboxes+/$inboxId_/cases+/$caseId.information'
