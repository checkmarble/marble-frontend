export type RoutePath =
  ...
  | '/ressources/cases/edit-snooze'
  | '/ressources/cases/edit-status'
  | '/ressources/cases/edit'
...
export type RouteID =
  ...
  | 'routes/_builder+/cases+/$caseId_.sanctions.$decisionId+/_layout'
  | 'routes/_builder+/cases+/$caseId_.sanctions.$decisionId+/_index'
  | 'routes/_builder+/cases+/$caseId_.sanctions.$decisionId+/files'
  | 'routes/_builder+/cases+/$caseId_.sanctions.$decisionId+/hits'
  ...
  | 'routes/_builder+/scenarios+/$scenarioId+/builder'
  ...
  | 'routes/ressources+/cases+/edit-snooze'
  | 'routes/ressources+/cases+/edit-status'
  | 'routes/ressources+/cases+/edit'
