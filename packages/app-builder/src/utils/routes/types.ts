export type RoutePath =
  ...
  | '/inboxes'
  | '/inboxes/:inboxId/'
  | '/inboxes/:inboxId/cases/:caseId'
  | '/inboxes/:inboxId/cases/:caseId/decisions'
  | '/inboxes/:inboxId/cases/:caseId/files'
  | '/inboxes/:inboxId/cases/:caseId/information'
  | '/lists'
  | '/lists/:listId'
  | '/scenarios'
...
export type RouteID =
  ...
  | 'routes/_builder+/inboxes+/_layout'
  | 'routes/_builder+/inboxes+/$inboxId+/_index'
  | 'routes/_builder+/inboxes+/$inboxId+/cases+/$caseId._layout'
  | 'routes/_builder+/inboxes+/$inboxId+/cases+/$caseId._index'
  | 'routes/_builder+/inboxes+/$inboxId+/cases+/$caseId.decisions'
  | 'routes/_builder+/inboxes+/$inboxId+/cases+/$caseId.files'
  | 'routes/_builder+/inboxes+/$inboxId+/cases+/$caseId.information'
  | 'routes/_builder+/inboxes+/_index'
