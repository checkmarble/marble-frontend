export type RoutePath =
  ...
  | '/app-router'
  | '/healthcheck'
  | '/ressources/analytics/available_filters/:scenarioId'
  | '/ressources/analytics/decisions_outcomes_per_day/:scenarioId'
  | '/ressources/analytics/query/:queryName'
...
export type RouteID =
  ...
  | 'routes/app-router'
  | 'routes/healthcheck'
  | 'routes/ressources+/analytics+/available_filters.$scenarioId'
  | 'routes/ressources+/analytics+/decisions_outcomes_per_day.$scenarioId'
  | 'routes/ressources+/analytics+/query.$queryName'
