...
export const validTimezones = [
  ...
  'NZ-CHAT',
  'Navajo',
  'PRC', // china - it's called "CST" in some sources but go expects the name "PRC"
  'Pacific/Apia',
  'Pacific/Auckland',
  ...
  'W-SU', // west soviet union - AKA Moscow Time
  'Zulu', // same as UTC
...
export type ValidTimezone = (typeof validTimezones)[number];
