...
const handleResult = <T extends DataReturnType<any, any> | Response>(value: T, exit: ExitFunction) => {
...
export const handleRedirectMiddleware = createMiddleware([], async function handleRedirectMiddleware(_, next, exit) {
  try {
