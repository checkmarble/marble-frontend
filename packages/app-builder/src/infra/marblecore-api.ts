import { createBasicFetch, createFetchWithAuthMiddleware, marblecoreApi, type TokenService } from 'marble-api';
...
export function initializeMarbleCoreAPIClient({ request, baseUrl }: { request: Request; baseUrl: string }): {
