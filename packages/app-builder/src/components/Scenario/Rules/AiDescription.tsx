    ...
    >
      ...
      {description ? (
        <div
          ...
          className="bg-surface-card rounded-v2-s border border-l-2 border-l-purple-65 border-grey-95  text-black text-small overflow-hidden transition-all duration-500"
