  ...
  return (
    <div className="flex items-center gap-1 text-xs">
      {displayedFiles.map((doc) => (
        <div
          key={doc.id}
          className="border-grey-90 bg-surface-card flex h-6 max-w-24 items-center gap-0.5 rounded-v2-md border px-1.5 font-medium"
        >
      ...
      {filesRest > 0 ? (
        <div className="border-grey-90 bg-surface-card flex h-6 items-center gap-0.5 rounded-v2-md border px-1.5 font-medium">
