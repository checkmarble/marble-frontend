...
export const EscalationConditionRow = ({
  ...
  return (
    <div className="flex items-center gap-v2-sm">
      <span className="text-s text-grey-placeholder px-2">{t('cases:overview.panel.escalation.from')}</span>
      ...
      <span className="text-s text-grey-placeholder px-2">{t('cases:overview.panel.escalation.escalate_to')}</span>
