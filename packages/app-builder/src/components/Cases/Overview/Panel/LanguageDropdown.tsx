    ...
    <MenuCommand.Menu open={disabled ? false : open} onOpenChange={disabled ? undefined : setOpen}>
      <MenuCommand.Trigger>
        <button
          type="button"
          disabled={disabled}
          className="bg-purple-background text-purple-primary text-xs font-medium px-v2-sm py-v2-xs rounded-sm flex items-center gap-v2-xs w-fit border border-transparent dark:bg-transparent dark:border-purple-primary disabled:opacity-50 disabled:cursor-not-allowed"
        >
