...
export function UserInfo({
  ...
  return (
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content
          className="bg-surface-card border-grey-90 animate-slide-up-and-fade z-50 w-full max-w-xs rounded-md border border-solid p-6 drop-shadow-md will-change-auto min-w-64"
          side="bottom"
          align="start"
          sideOffset={4}
        >
