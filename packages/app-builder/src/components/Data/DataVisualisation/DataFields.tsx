  ...
  return (
    <DataVisualisationProvider value={contextValue}>
      <div className={cn('flex flex-col gap-y-2', className)}>
        ...
        {columnCount === 1 ? (
          <div className="grid auto-rows-[minmax(2rem,auto)] grid-cols-[max-content_1fr] gap-x-4 gap-y-2 break-all">
          ...
          <div className="flex items-start gap-x-4">
            {fieldsByColumn.map((colFields, i) => (
              <div
                key={i}
                className="grid min-w-0 flex-1 auto-rows-[minmax(2rem,auto)] grid-cols-[max-content_1fr] gap-x-4 gap-y-2 break-all"
              >
