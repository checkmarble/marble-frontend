...
export type ClusterRfData = {
  /** The branch entry point, any table-backed record, rendered with the record card. */
  root: PersonRfData;
  nodeCount: number;
...
export type GraphRfEdge = Edge<GraphRfEdgeData, 'link' | 'match' | 'hypernode'>;
