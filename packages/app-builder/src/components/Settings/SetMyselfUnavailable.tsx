...
export function SetMyselfUnavailable() {
  ...
  return (
    <Modal.Root open={open} onOpenChange={setOpen}>
      <Modal.Trigger>
        <div className="flex items-center gap-2 cursor-pointer p-2 rounded-sm hover:bg-green-34 text-grey-background-light font-semibold bg-green-38 transition-all duration-100">
