  ...
  return (
    <div className={cn('flex flex-row flex-wrap gap-2', props.className)}>
      {errorModels.map((errorModel, i) => (
        <span
          key={i}
          className="bg-red-95 text-s text-red-47 flex h-8 items-center justify-center rounded-sm border border-transparent px-2 py-1 font-medium dark:bg-transparent dark:border-red-47"
        >
