...
export function Examples({
  ...
  return (
    <table className="border-grey-border table-auto border-collapse border">
      ...
      <thead>
        <tr>
          <th className="text-grey-primary bg-grey-background-light border-grey-border border px-xs text-start text-xs font-normal">
      ...
      <tbody>
        {config.examples.map(({ left, right, resultsScores }) => {
          ...
          return (
            <tr key={`${left}-${right}`}>
              <td className="text-grey-primary border-grey-border border px-xs text-xs font-normal">{left}</td>
              <td className="text-grey-primary border-grey-border border px-xs text-xs font-normal">{right}</td>
