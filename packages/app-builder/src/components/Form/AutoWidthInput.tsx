...
export const AutoWidthInput = ({
  ...
  maxWidth = 800,
  ...props
}: AutowidthInputProps & { ref?: React.Ref<HTMLInputElement> }) => {
  ...
  useEffect(() => {
    ...
    } else if (props.placeholder && placeholderWidth && placeholderIsMinWidth) {
  ...
  }, [usedValue, props.placeholder, extraWidth, placeholderIsMinWidth, onAutosize, setInputWidth, minWidth, maxWidth]);
