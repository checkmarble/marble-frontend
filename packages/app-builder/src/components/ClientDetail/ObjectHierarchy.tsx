  ...
  return (
    <div className="grid grid-cols-[60px_60px_1fr]">
      ...
      {tree.children.map((child, idx) => {
        return (
          <div key={`child_${child.objectType}-${idx}`} className="grid grid-cols-subgrid col-span-full">
      ...
      {parent.children.map((child, idx) => {
        return (
          <div key={`parent_child_${child.objectType}-${idx}`} className="grid grid-cols-subgrid col-span-full">
