...
import { type AstBuilderNodeState } from '@app-builder/components/AstBuilder/node-store';
...
import { type ComponentStateType } from '@marble/shared';
...
export default function ScenarioBuilderPage() {
  ...
  const nodeStoreRef = useRef<ComponentStateType<typeof AstBuilderNodeState>>();
