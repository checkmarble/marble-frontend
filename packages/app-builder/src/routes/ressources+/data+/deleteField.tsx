...
type DeleteFieldActionResult = ServerFnResult<
  { success: true; data: DestroyDataModelReport } | { success: false; errors: unknown; error?: string }
>;

export const action = createServerFn(
  [authMiddleware],
  async function deleteFieldAction({ request, context }): DeleteFieldActionResult {
    ...
    const parsed = deleteFieldPayloadSchema.safeParse(raw);
    ...
    try {
      const result = await dataModelRepository.deleteField(parsed.data.fieldId, {
