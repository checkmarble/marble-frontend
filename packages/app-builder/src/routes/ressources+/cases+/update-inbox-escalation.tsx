...
type UpdateInboxEscalationActionResult = ServerFnResult<Response | { success: boolean; errors?: unknown }>;

export const action = createServerFn(
  [handleRedirectMiddleware, authMiddleware],
  async function updateInboxEscalationAction({ request, context }): UpdateInboxEscalationActionResult {
    ...
    const payload = updateInboxEscalationPayloadSchema.safeParse(rawData);
    ...
    try {
      ...
      setToastMessage(toastSession, {
        type: 'success',
        message: t('cases:overview.panel.escalation.saved'),
      });
