...
import { buildEditScoreThresholdsPayloadSchema } from '@app-builder/queries/scenarios/edit-score-thresholds';
import invariant from 'tiny-invariant';
import { z } from 'zod/v4';

export const action = createServerFn(
  [handleRedirectMiddleware, authMiddleware],
  async function editScoreThresholdsAction({ request, context, params }) {
    ...
    const schema = buildEditScoreThresholdsPayloadSchema(t);
    ...
    try {
      await scenario.updateScenarioIteration(iterationId, parsedPayload.data);
