...
export const loader = createServerFn([authMiddleware], async function csDebugUpdateJobsLoader({ request, context }) {
  ...
  const result = await continuousScreening.listDebugUpdateJobs({
