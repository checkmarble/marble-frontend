...
const filtersLoader = createServerFn()
  .middleware([authMiddleware])
  .handler(async function filtersLoader({ context }) {
...
export const Route = createFileRoute('/_app/_builder/settings/analytics/filters')({
...
function Filters() {
  ...
  const { filters, dataModel, triggerFieldItems, linkedFieldItems } = Route.useLoaderData();
