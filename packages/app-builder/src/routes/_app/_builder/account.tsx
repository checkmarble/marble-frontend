...
import { toggleProboPreferences, useProboBannerReady } from '@app-builder/services/consent/ProboCookieBanner';
...
export const Route = createFileRoute('/_app/_builder/account')({
  staticData: {
    BreadCrumbs: [
...
function AccountPage() {
  ...
  const isProboBannerReady = useProboBannerReady();
            ...
            <div className="bg-surface-card border-grey-border flex flex-col gap-lg rounded-lg border p-md">
              ...
              {isProboBannerReady ? (
                <Button
                  type="button"
                  variant="secondary"
                  className="fixed bottom-md end-md z-30 shadow-md sm:bottom-lg sm:end-lg"
                  onClick={toggleProboPreferences}
                >
