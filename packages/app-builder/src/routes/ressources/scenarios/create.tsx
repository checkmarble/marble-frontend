...
export async function action({ request }: ActionArgs) {
  ...
  console.log("parsedForm : ", parsedForm.data)
  ...
  try {
    ...
    console.log("created scenario iteration: ", scenarioIteration)
    return redirect(
      getRoute('/scenarios/:scenarioId/i/:iterationId', { scenarioId: fromUUID(scenario.id), iterationId: fromUUID(scenarioIteration.id) })
    );
  } catch (error) {
