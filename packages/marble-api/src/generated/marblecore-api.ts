...
export type ConstantDto =
  ...
  | null;
export type EvaluationErrorCodeDto =
  | 'UNEXPECTED_ERROR'
  | 'UNDEFINED_FUNCTION'
...
export type CaseStatusForCaseEventDto =
  | 'pending'
  | 'investigating'
  | 'closed'
  | 'open'
...
export type ScenarioValidationErrorCodeDto =
...
export type SanctionCheckEntityDto =
  | 'Thing'
  | 'Address'
  | 'Airplane'
  | 'Asset'
...
export function updateCase(
  caseId: string,
  updateCaseBodyDto: UpdateCaseBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function assignUser(
  caseId: string,
  assignCaseBodyDto: AssignCaseBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function getPaginatedCaseDecisions(
  caseId: string,
  {
    cursorId,
    limit,
  ...
  return oazapfts.ok(
    ...
    >(
      `/cases/${encodeURIComponent(caseId)}/decisions${QS.query(
        QS.explode({
          cursor_id: cursorId,
          limit,
        }),
 ...
 */
export function addDecisionsToCase(
  caseId: string,
  body: {
 ...
 */
export function updateTagsForCase(
  caseId: string,
  body: {
  ...
  return oazapfts.ok(
    ...
    >(
      `/cases/${encodeURIComponent(caseId)}/case_tags`,
      oazapfts.json({
        ...opts,
        method: 'POST',
        body,
 ...
 */
export function sarCreate(
  caseId: string,
  createSuspiciousActivityReportBodyDto: CreateSuspiciousActivityReportBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function sarUpdate(
  caseId: string,
  reportId: string,
  updateSuspiciousActivityReportBodyDto: UpdateSuspiciousActivityReportBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function sarUpload(
  caseId: string,
  reportId: string,
  uploadSuspiciousActivityReportBodyDto?: UploadSuspiciousActivityReportBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/cases/${encodeURIComponent(caseId)}/sar/${encodeURIComponent(reportId)}/file`,
      oazapfts.multipart({
        ...opts,
        method: 'POST',
 ...
 */
export function listScheduledExecutions(
  {
    scenarioId,
  }: {
    scenarioId?: string;
 ...
 */
export function createSnoozeForDecision(
  decisionId: string,
  snoozeDecisionInputDto: SnoozeDecisionInputDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/decisions/${encodeURIComponent(decisionId)}/snooze`,
      oazapfts.json({
        ...opts,
        method: 'POST',
...
export function createIngestion(objectType: string, body: object, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    ...
    >(
      `/ingestion/${encodeURIComponent(objectType)}`,
      oazapfts.json({
        ...opts,
        method: 'POST',
        body,
 ...
 */
export function getIngestedObject(
  tableName: string,
  objectId: string,
  opts?: Oazapfts.RequestOpts,
) {
 ...
 */
export function listClientObjects(
  tableName: string,
  clientDataListRequestBody: ClientDataListRequestBody,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/client_data/${encodeURIComponent(tableName)}/list`,
      oazapfts.json({
        ...opts,
        method: 'POST',
...
export function createCustomList(
  createCustomListBodyDto: CreateCustomListBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function updateCustomList(
  customListId: string,
  updateCustomListBodyDto: UpdateCustomListBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function createCustomListValue(
  customListId: string,
  createCustomListValueBody: CreateCustomListValueBody,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function deleteCustomListValue(
  customListId: string,
  customListValueId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function createScenario(
  scenarioCreateInputDto: ScenarioCreateInputDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function updateScenario(
  scenarioId: string,
  scenarioUpdateInputDto: ScenarioUpdateInputDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function validateAstNode(
  scenarioId: string,
  scenarioAstValidateInputDto?: ScenarioAstValidateInputDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/scenarios/${encodeURIComponent(scenarioId)}/validate-ast`,
      oazapfts.json({
        ...opts,
        method: 'POST',
 ...
 * List iterations
 */
export function listScenarioIterations(
  {
    scenarioId,
  }: {
    scenarioId?: string;
 ...
 */
export function createScenarioIteration(
 ...
 */
export function createDraftFromScenarioIteration(
 ...
 */
export function updateScenarioIteration(
  scenarioIterationId: string,
 ...
 */
export function scheduleScenarioExecution(
  scenarioIterationId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 */
export function validateScenarioIteration(
  scenarioIterationId: string,
  body?: {
 ...
 */
export function getScenarioIterationActiveSnoozes(
  scenarioIterationId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 */
export function deleteSanctionCheckConfig(
  scenarioIterationId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 */
export function upsertSanctionCheckConfig(
  scenarioIterationId: string,
  sanctionCheckConfigDto?: SanctionCheckConfigDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<{
 ...
 */
export function updateSanctionCheckMatch(
  matchId: string,
  updateSanctionCheckMatchDto: UpdateSanctionCheckMatchDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<{
      ...
      `/sanction-checks/matches/${encodeURIComponent(matchId)}`,
      oazapfts.json({
        ...opts,
        method: 'PATCH',
 ...
 */
export function searchSanctionCheckMatches(
  sanctionCheckRefineDto?: SanctionCheckRefineDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<{
 ...
 */
export function refineSanctionCheck(
  sanctionCheckRefineDto?: SanctionCheckRefineDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 * List rules
 */
export function listScenarioIterationRules(
  {
    scenarioIterationId,
  }: {
    scenarioIterationId?: string;
  ...
  return oazapfts.ok(
    ...
    >(
      `/scenario-iteration-rules${QS.query(
        QS.explode({
          scenarioIterationId,
        }),
      )}`,
 ...
 */
export function createScenarioIterationRule(
  createScenarioIterationRuleBodyDto: CreateScenarioIterationRuleBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function updateScenarioIterationRule(
  ruleId: string,
  updateScenarioIterationRuleBodyDto: UpdateScenarioIterationRuleBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function listScenarioPublications(
  {
    scenarioId,
    scenarioIterationId,
  }: {
  ...
  return oazapfts.ok(
    ...
    >(
      `/scenario-publications${QS.query(
        QS.explode({
          scenario_id: scenarioId,
 ...
 */
export function getScenarioPublicationPreparationStatus(
  scenarioIterationId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    ...
    >(
      `/scenario-publications/preparation${QS.query(
        QS.explode({
          scenario_iteration_id: scenarioIterationId,
        }),
      )}`,
 ...
 */
export function startScenarioPublicationPreparation(
  body: {
    scenario_iteration_id: string;
  },
  opts?: Oazapfts.RequestOpts,
 ...
 */
export function patchDataModelTable(
  tableId: string,
  ...
  return oazapfts.ok(
    ...
    >(
      `/data-model/tables/${encodeURIComponent(tableId)}`,
      oazapfts.json({
        ...opts,
        method: 'PATCH',
 ...
 */
export function postDataModelTableField(
  tableId: string,
  createTableFieldDto: CreateTableFieldDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/data-model/tables/${encodeURIComponent(tableId)}/fields`,
      oazapfts.json({
        ...opts,
        method: 'POST',
 ...
 */
export function patchDataModelField(
  fieldId: string,
  updateTableFieldDto: UpdateTableFieldDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/data-model/fields/${encodeURIComponent(fieldId)}`,
      oazapfts.json({
        ...opts,
        method: 'PATCH',
 ...
 */
export function postDataModelTableLink(
  createTableLinkBody: CreateTableLinkBody,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function listDataModelPivots(
  {
    tableId,
  }: {
    tableId?: string;
 ...
 * Create a pivot
 */
export function createDataModelPivot(
  createPivotInputDto: CreatePivotInputDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function postDataModelTableNavigationOption(
  tableId: string,
  createNavigationOptionDto: CreateNavigationOptionDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
    ...
    >(
      `/data-model/tables/${encodeURIComponent(tableId)}/navigation_options`,
      oazapfts.json({
        ...opts,
        method: 'POST',
 ...
 */
export function setDataModelTableOptions(
  tableId: string,
  setDataModelTableOptionsBodyDto: SetDataModelTableOptionsBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
 ...
 */
export function addInboxUser(
  inboxId: string,
  addInboxUserBodyDto: AddInboxUserBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function createWebhook(
  webhookRegisterBodyDto: WebhookRegisterBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function updateWebhook(
  webhookId: string,
  webhookUpdateBodyDto: WebhookUpdateBodyDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
...
export function createTestRun(
  testRunCreateInputDto: TestRunCreateInputDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
